...
Try to acquire a distributed shared lock that will expire automatically after
the given amount of time in seconds. You can release the lock manually with
L</"unlock">.
  ...
  # Wait for a shared lock used by up to 5 parties
  sleep 1 until $minion->lock('some_web_service', 300, {limit => 5});
  ...
